...
class Pipeline:
    ...
    def process_img(self, img):
        ...
        classes, scores, boxes, masks, obb_corners, obb_centers, num_dets_to_consider = self.object_detection.post_process(preds)
...
if __name__ == '__main__':
    ...
    frame_count = 0
    for img_p in imgs:
        labeled_img = pipeline.process_img(img_p)
